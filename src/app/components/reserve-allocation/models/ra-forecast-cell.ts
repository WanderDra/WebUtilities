...
import { IRACellConfig, IRAForecastCoverageConfig } from "../interfaces/ra-config.interfaces";
...
export class RAForecastCoverageCell extends RAChartCell {
  showDetailsPopup: boolean;
  selectedCell: boolean;
  raCoverageDetail: IRACoverageDetail;

  constructor(config: IRAForecastCoverageConfig) {
    super(config);
    this.initDetailData(config);
  }

  initDetailData(config: IRAForecastCoverageConfig): void {
    this.raCoverageDetail = config.raCoverageDetail;
  }
}